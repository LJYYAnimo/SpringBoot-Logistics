                ...
                <div class="layui-card-body">
                    <form class="layui-form">
                        <div class="layui-container">
                            <div class="layui-row">
                                <input type="hidden" name="id" value="${result.orderEntity.id!}" >
                                <input type="hidden" name="orderNo" value="${result.orderEntity.orderNo!}" >
                                <div class="layui-col-md4">
                                    <label class="layui-form-label">购货单位</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="customerName" lay-verify="required" class="layui-input" value="${result.orderEntity.customerName!}">
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                                    <label class="layui-form-label">联系电话</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="customerTel" class="layui-input" value="${result.orderEntity.customerTel!}">
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                            ...
                            <div class="layui-row" style="margin: 10px 0px">
                                <div class="layui-col-md4">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="invoiceType" lay-verify="required" class="layui-input" value="${result.orderEntity.invoiceType!}">
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                                    <label class="layui-form-label">发票编号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="invoiceNo" class="layui-input" value="${result.orderEntity.invoiceNo!}">
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                                    <label class="layui-form-label">提货人信息</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="getGoodsPerson" class="layui-input" value="${result.orderEntity.getGoodsPerson!}">
                                    </div>
                                </div>
                            ...
                            <div class="layui-row" style="margin: 10px 0px">
                                <div class="layui-col-md4">
                                    ...
                                    <div class="layui-input-block" style="width: 300px;">
                                        <#if result.orderEntity.payStatus == "NOT_PAY">
                                        ...
                                        <#elseif result.orderEntity.payStatus == "PAY_SOME">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="2" title="未付款">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="3" title="部分支付" checked="">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="4" title="已结清">
                                        <#elseif result.orderEntity.payStatus == "PAY_ALL">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="2" title="未付款">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="3" title="部分支付">
                                            <input type="radio" name="payStatus" lay-filter="payStatus" value="4" title="已结清" checked="">
                                        </#if>
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="paidAmount" class="layui-input paidAmount" value="${result.orderEntity.paidAmount!}">
                                    </div>
                                </div>
                                <div class="layui-col-md4">
                                    <label class="layui-form-label">未付货款</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="unpaidAmount" class="layui-input unpaidAmount" value="${result.orderEntity.unpaidAmount!}">
                                    </div>
                                </div>
                        ...
                        <colgroup>
                            ...
                            <#if result?exists && result.goodsList?has_content>
                                <#list result.goodsList as good>
                                    <tr class="contentTr">
                                        <td style="text-align: center" class="delete_animo">
                                            <button type="button"><i class="layui-icon">&#xe640;</i></button>
                                        </td>
                                        <td><input type="text" name="goodsName" class="layui-input" value="${good.goodsName!}"></td>
                                        <td><input type="text" name="goodsDetailInfo" class="layui-input" value="${good.goodsDetailInfo!}"></td>
                                        <td><input type="number" name="number" class="layui-input number" value="${good.number!}"></td>
                                        <td><input type="text" name="weight" class="layui-input weight" value="${good.weight!}"></td>
                                        <td><input type="text" name="pricingMethod" class="layui-input" value="${good.pricingMethod!}"></td>
                                        <td><input type="text" name="price" class="layui-input price" value="${good.price!}"></td>
                                        <td><input type="text" name="subtotalAmount" class="layui-input subtotalAmount" value="${good.subtotalAmount!}"></td>
                                        <td><input type="text" name="remark" class="layui-input" value="${good.remark!}"></td>
                                        <td style="display: none;"><input type="hidden" name="goodsId" value="${good.id!}" ></td>
                                    </tr>
                                </#list>
                            <#else>
                                <tr class="contentTr">
                                    ...
                                    <td style="display: none;"><input type="hidden" name="goodsId" value="" ></td>
                                </tr>
                            </#if>
                            <tr class="footTr">
                        ...
                        <div class="layui-form-item" style="float: right;margin-top: 10px;">
                            <div class="layui-input-block">
                                <button class="layui-btn" lay-submit lay-filter="orderAddForm">修改</button>
...
<script>
    layui.use(['laydate', 'form', 'jquery'], function () {
        ...
        var laydate = layui.laydate,
                ...
                $ = layui.$;
        var date = null;
        if(${result.orderEntity.getGoodsDate} != null)
        {
           date = new Date('${result.orderEntity.getGoodsDate} 00:00:00');
        }
        //执行一个laydate实例
        laydate.render({
        ...
        $("#append_table").on("click", ".delete_animo", function () {
            var delId = $(this).parent().find("td").eq(9).find("input").val();
            if(delId != null && delId != undefined && delId.trim() != ""){
                delGoodsList.push(delId);
            }
        ...
        form.on('submit(orderAddForm)', function (data) {
                ...
                for(var index = 1; index <= 9; index++){
                    switch (index){
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            detail.id = $(contentList[i]).find("td").eq(index).find("input").val();
                            break;
                    }
                }
            ...
            postData.delGoodsList = delGoodsList;
